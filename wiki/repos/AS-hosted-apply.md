...
repos:
  - hosted-apply
source: "C:\JT Repositories\hosted-apply\CLAUDE.md"
captured: 2026-09-15
sha256_short: 31f6cd37b1f4
updated: 2026-09-15
---

# hosted-apply — repo memory

> **Snapshot, not the source.** The live file is `C:\JT Repositories\hosted-apply\CLAUDE.md` — that is what Claude Code actually loads in the repo. This is a read-only copy captured 2026-09-15 (71 lines, sha256 `31f6cd37b1f4`) so the vault can answer questions about repo conventions without opening the repo.
