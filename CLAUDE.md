...
- **Log ticket work** → create or append to `/tickets/<TEAM>/<KEY>.md` per the ticket protocol.
...
5. **Never overwrite** a design doc or `/tickets` entry blindly. Read it first, then merge.
